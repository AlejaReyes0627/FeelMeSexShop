...
export { Producto};
@Component({
  selector: 'app-filtro-lenceria',
  templateUrl: './filtro-lenceria.component.html',
  styleUrls: ['./filtro-lenceria.component.css']
})
export class FiltroLenceriaComponent implements OnInit {
  ...
  public mostrarProductosAscendente() {
    var tipo = 'select';
    var sql = 'SELECT * FROM producto WHERE idCategoria =6 ORDER BY precio;';
  ...
  public mostrarProductosDescendente() {
    var tipo = 'select';
    var sql = 'SELECT * FROM producto WHERE idCategoria =6 ORDER BY precio DESC;';
