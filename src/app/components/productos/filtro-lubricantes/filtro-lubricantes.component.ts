...
export { Producto};
@Component({
  selector: 'app-filtro-lubricantes',
  templateUrl: './filtro-lubricantes.component.html',
  styleUrls: ['./filtro-lubricantes.component.css']
})
export class FiltroLubricantesComponent implements OnInit {
  ...
  public mostrarProductosAscendente() {
    var tipo = 'select';
    var sql = 'SELECT * FROM producto WHERE idCategoria =7 ORDER BY precio;';
  ...
  public mostrarProductosDescendente() {
    var tipo = 'select';
    var sql = 'SELECT * FROM producto WHERE idCategoria =7 ORDER BY precio DESC;';
