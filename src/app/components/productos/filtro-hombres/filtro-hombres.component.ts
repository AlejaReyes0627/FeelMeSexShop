...
@Component({
  selector: 'app-filtro-hombres',
  templateUrl: './filtro-hombres.component.html',
  styleUrls: ['./filtro-hombres.component.css']
})
export class FiltroHombresComponent implements OnInit {
  title = 'zoo';
