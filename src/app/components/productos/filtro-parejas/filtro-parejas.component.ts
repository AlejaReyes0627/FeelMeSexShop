...
export { Producto };
@Component({
  selector: 'app-filtro-parejas',
  templateUrl: './filtro-parejas.component.html',
  styleUrls: ['./filtro-parejas.component.css']
})
export class FiltroParejasComponent implements OnInit {
  title = 'zoo';
