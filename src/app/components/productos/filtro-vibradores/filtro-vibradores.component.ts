...
export { Producto};
@Component({
  selector: 'app-filtro-vibradores',
  templateUrl: './filtro-vibradores.component.html',
  styleUrls: ['./filtro-vibradores.component.css']
})
export class FiltroVibradoresComponent implements OnInit {
  ...
  public mostrarProductosAscendente() {
    var tipo = 'select';
    var sql = 'SELECT * FROM producto WHERE idCategoria =4 ORDER BY precio;';
  ...
  public mostrarProductosDescendente() {
    var tipo = 'select';
    var sql = 'SELECT * FROM producto WHERE idCategoria =4 ORDER BY precio DESC;';
